...
module FpAdd (
    ...
    logic [36:0] A_f_shifted;
    logic [36:0] B_f_shifted;
    ...
    assign A_f_shifted = A_larger              ? {1'b0, A_f, 18'b0} :
                         (exp_diff_A > 8'd35) ? 37'b0 :
                         ({1'b0, A_f, 18'b0} >> exp_diff_A);
    assign B_f_shifted = ~A_larger             ? {1'b0, B_f, 18'b0} :
                         (exp_diff_B > 8'd35) ? 37'b0 :
    ...
    assign pre_frac_shft = {pre_frac, 17'b0} << (shft_amt + 8'd1);
    assign uflow_shift   = {pre_frac, 17'b0} << shft_amt;
